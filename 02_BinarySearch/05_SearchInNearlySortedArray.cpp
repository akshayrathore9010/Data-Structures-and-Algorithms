// Given a sorted array `arr` of size `N`, some elements of the array are
// moved to either of the adjacent positions i.e., `arr[i]` may be
// present at `arr[i+1]` or `arr[i-1]`. The task is to search for an
// element in this array.

// Input: arr[] = {3, 4, 5, 6, 7, 8, 9}, key = 5
// Output: 2
// Explanation: Output is the index of 5 in the given array i.e., 2

// Input: arr[] = {10, 3, 40, 20, 50, 80, 70}, key = 40
// Output: 2
// Explanation: Output is the index of 40 in the given array i.e., 2
